...
def clipboard():
    ...
    messagebox.showinfo("IThank you for visiting our application", "Password copied to clipboard successfully!")
...
photo = tk.PhotoImage(file= "D:\Campusvalley tasks\password generator/secure.png")
